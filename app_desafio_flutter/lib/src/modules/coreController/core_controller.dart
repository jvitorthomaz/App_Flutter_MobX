...
abstract class _CoreControllerBase with Store {
  ...
  // _CoreControllerBase(this.matchStore, this.sportsStore, this.championshipStore, this.bonusStore, this.wonBetStore, this.tipStore, this.sportsService, this.championshipService, this.wonBetService, this.tipService, this.bonusService, this.matchService);
