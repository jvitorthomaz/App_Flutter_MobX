...
import 'package:app_desafio_flutter/src/core/ui/components/fact_team_widget.dart';
import 'package:flutter/material.dart';

class FactsCardWidget extends StatelessWidget {
  final String img;
  final String team;

  const FactsCardWidget({super.key, required this.img, required this.team});
